...
import Logo from '../assets/image/Teenager.png'
export default function Navbar() {
    return (
        <div>
            <Box bg="white" minWidth="100%" height="10vh" boxShadow='md' px='5' rounded='md' display="flex" justifyContent="flex-start" alignItems="center" position="fixed" top="0" zIndex="10">
