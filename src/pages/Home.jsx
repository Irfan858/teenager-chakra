          ...
          <Box m={5}>
            <Stack spacing={6}>
              ...
              <Flex justifyContent="baseline">
                ...
                <Spacer />
                <Button colorScheme="blue" size="md" variant="ghost">Lihat Semua</Button>
              </Flex>
              ...
              <HStack spacing={3}>
                <Box p={5} width="50%" bgColor="white" height="60vh" boxShadow="lg" borderRadius="10">
                  <Flex>
                    <Text as="span" fontSize="xl" fontWeight="semibold">Tugas</Text>
                    <Spacer />
                    <Button colorScheme="blue" size="md" variant="ghost">Lihat Semua</Button>
                  </Flex>
                ...
                <Box p={5} width="50%" bgColor="gray.100" height="60vh" boxShadow="lg" borderRadius="10">
                  <Flex>
                    <Text as="span" fontSize="xl" fontWeight="semibold">Diskusi</Text>
                    <Spacer />
                    <Button colorScheme="blue" size="md" variant="ghost">Lihat Semua</Button>
                  </Flex>
                  <Stack mt={4} spacing={3}>
